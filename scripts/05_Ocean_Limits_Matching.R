...
## Lets do one for sanity checking
# testing <- coloring_map_matching(
#   D=list_AitDist[[1]],
#   nclusters = 3,
...
list_cluster_membership_matched = parallel::mclapply(
  list_AitDist,
  function(x){
...
saveRDS(list_cluster_membership_matched,
        file = paste0(savingdir,'/','list_cluster_membership_matched_10neigh_k3'))
...
saveRDS(list_cluster_membership_matched,
        file = paste0(savingdir,'/','list_cluster_membership_matched_05neigh_k3'))
...
saveRDS(list_cluster_membership_matched,
        file = paste0(savingdir,'/','list_cluster_membership_matched_03neigh_k3'))
